...
public class ReceiveUcodeAdapter extends RecyclerView.Adapter<ReceiveUcodeAdapter.ViewHolder>{
    ...
    public ReceiveUcodeAdapter(List<UcodeMessage> UcodeList){//构造函数，把要展示的数据源传进来，并赋值给全局变量mFruitList
        mData=UcodeList;
    }
