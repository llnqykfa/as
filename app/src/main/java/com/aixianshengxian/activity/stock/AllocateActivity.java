...
public class AllocateActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.iv_delete:
                ...
                break;
            case R.id.btn_stock:
                Intent intent1 = new Intent(AllocateActivity.this,StockRecordActivity.class);
                Bundle bundle1 = new Bundle();
                bundle1.putSerializable("Activity","AllocateActivity");
...
//                            PageData pageData = GsonUtil.getGson().fromJson(response.getData(),PageData.class);
                            ...
                            Intent intent1 = new Intent(AllocateActivity.this,AllocateDetailActivity.class);
                            Bundle bundle1 = new Bundle();
