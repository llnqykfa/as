...
public class StockRemovalActivity extends BaseActivity implements View.OnClickListener {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_search:
                ...
                if (ucode.equals("")) {
                    ...
                    getQueryStock(ucode);
                    /*Intent intent1 = new Intent(StockRemovalActivity.this,RemovalDetailActivity.class);
            ...
            case R.id.iv_delete:
                ...
                break;
            case R.id.btn_stock:
                Intent intent1 = new Intent(StockRemovalActivity.this,StockRecordActivity.class);
                Bundle bundle1 = new Bundle();
                bundle1.putSerializable("Activity","StockRemovalActivity");
                intent1.putExtras(bundle1);
                startActivity(intent1);
                break;
            default:
