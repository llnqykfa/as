        ...
        if (files != null && !files.isEmpty()) {
            ...
            for (String key : files.keySet()) {
             ...
             multipartBuilder.addPart(Headers.of("Content-Disposition",
                        ...
                        fileBody);
//                multipartBuilder.addFormDataPart("file","Content-Disposition"+
...
//                                Gson gson = new Gson();
                                ...
                                ((GsonResponseHandler)mResponseHandler).onSuccess(code, response_body);
                            } catch (Exception e) {
